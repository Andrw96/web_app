...
# 4. PERSISTENCIA POR URL (REFRESCO)
...
# --- FUNCIÓN DE LOGIN (SOLUCIÓN CLIC ÚNICO) ---
...
# --- APLICACIÓN COMPLETA ---
    ...
    # Asegurar nombre si entramos por refresco
